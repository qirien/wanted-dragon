...
label cyril6:
    ...
    c "I thank you for your concern Princess.  I am grateful for that.  But what can I do?  I have my standing before the council to think of and do not think they would let the matter go lightly."
    ...
    p "You cannot {b}allow{/b} it? Perhaps I am mistaken, but it sounds as though you were trying to command YOUR future Queen? Surely even you would not be so ludicrously unintelligent."
    ...
    "(There! He’ll have quite a surprise when he gets in bed tonight! \"Interesting\" indeed, mwah ha ha ha ha ha ha!)"
    ...
    b "Very well. I hope you are successful in your endeavors."
    ...
    c "Oh well, yes.  I think the purpose is to… how do you propose that it’s played?  Perhaps we can invent a new sport and name it after you [p-name]."
