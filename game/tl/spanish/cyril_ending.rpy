...
translate spanish cyril_dark_epilogue_385cfc5b:
    ...
    p smile "Ahora es \"Su Majestad\", gracias a usted. No pensé que sería capaz de matar a Magnolia, pero me ha sorprendido."
...
translate spanish cyril_dark_epilogue_40de5718:
    ...
    p smile "Es una pena que mi padre tuviera que interponerse en su camino pero..., bueno, ya es agua pasada."
...
translate spanish cyril_dark_epilogue_53573c27:
    ...
    c "Tras matar a ese dragón, no sé cómo tardé tanto en darle su merecido a aquellos que se lo merecen."
...
translate spanish cyril_dark_epilogue_5d7e9daf:
    ...
    c "Su familia la estaba menospreciando. Se lo merecían."
...
translate spanish cyril_dark_epilogue_999538ad:
    ...
    p "Sí, y hay muchos más que merecen justicia. En realidad, he decidido permitirle que dictamine su sentencia reclamando esa justicia."
...
translate spanish cyril_dark_epilogue_a1306e2d:
    ...
    p smile "Me ha demostrado que es capaz de hacer grandes cosas. Hay un dragón, en el reino vecino, que ha acumulado mucho poder. ¿Lo conoce?"
...
translate spanish cyril_dark_epilogue_5c4e4894:
    ...
    p tsk "Entonces, asegúrese de que no me causa más problemas."
...
translate spanish cyril_dark_epilogue_7aa91dca:
    ...
    c "Me equivocaba. Recluirlos fue un error. Solo se merecen la muerte."

# game/cyril_ending.rpy:25
translate spanish cyril_dark_epilogue_eefe3d3f:

    # c "That is the only way."
    c "Es lo único que se podía hacer."
...
translate spanish cyril_dark_epilogue_ea04aca8:
    ...
    p smile "Bien, bien. Ha progresado mucho desde aquel medio mago tartamudo y torpe que solía ser. Me siento orgullosa de usted, Cyril."

# game/cyril_ending.rpy:27
translate spanish cyril_dark_epilogue_81596e84:

    # c "You have taught me much, your Majesty."
    c "Me ha enseñado mucho, Su Majestad."
...
translate spanish cyril_dark_epilogue_64d3b700:
    ...
    "Al final ha resultado serme bastante útil. No he necesitado la ayuda de un dragón después de todo."

# game/cyril_ending.rpy:29
translate spanish cyril_dark_epilogue_f3beb85c:

    # c "I owe it all to you."
    c "Se lo debo todo a usted."
...
translate spanish cyril_dark_epilogue_b9a1dbec:
    ...
    "Me iba a asegurar de que me recompensara por toda mi generosidad."
...
translate spanish cyril_scepter_epilogue_95078151:
    ...
    p_write "Academia de magos, Casa del Maestro Givvorn\n"
...
translate spanish cyril_scepter_epilogue_f1a5822e:
    ...
    p_write "Espero que ese memo que le está enseñando se dé cuenta de su potencial."
...
translate spanish cyril_scepter_epilogue_cf166524:
    ...
    p_write "De lo contrario, puede mandármelo a mí, la Reina de [k_name]."
...
translate spanish cyril_scepter_epilogue_39c90ea5:
    ...
    p tsk "Preferiría que no hiciera eso, Cyril el... ¿Cómo le llaman ahora en la Academia?"
...
translate spanish cyril_scepter_epilogue_426ad0d3:
    ...
    c "Cyril el Capaz. Bastante mejor que Cyril el Competente, pero me sigue pareciendo un adjetivo demasiado fuerte que soportar."
...
translate spanish cyril_scepter_epilogue_cc12d047:
    ...
    p angry "Basta de esa falsa humildad, Cyril. Si a la Reina le parece que lo mereces, es normal que a otros también."
...
translate spanish cyril_scepter_epilogue_e75c34e2:
    ...
    p "Ahora, sea útil y haga un conjuro para que aparezcan unos pasteles de canela."
...
translate spanish cyril_scepter_epilogue_6f68ede6:
    ...
    p smile "Después de eso, podría ser lo suficientemente capaz para pedirme ser mi acompañante en el baile de la Coronación este sábado."
...
translate spanish cyril_scepter_epilogue_2b7553d9:
    ...
    c "¡Vaya, los pasteles! Por supuesto. ¡{font=fonts/ankecallig-fg.ttf}Dulcis Cottura{/font}!"

# game/cyril_ending.rpy:66
translate spanish cyril_scepter_epilogue_e9d7b144:

    # p shout "No, you fool! Ask me! To accompany you!"
    p shout "¡No, idiota! ¡Pídamelo! Que vaya con usted."
...
translate spanish cyril_scepter_epilogue_899e0228:
    ...
    c hat laugh "Sí, sí. Por favor, acompáñeme a este baile, mi Reina. Sería un privilegio ir con usted."
...
translate spanish cyril_scepter_epilogue_a36e3481:
    ...
    p friendly "¿A que no era tan complicado? Por supuesto que puede venir conmigo. Coja uno de estos pasteles de canela, están deliciosos."
...
translate spanish cyril_dragon_epilogue_977420be:
    ...
    p surprised "¿Todavía sigue aquí, Cyril? Cuando yo aterrice, márchese. Me ha servido bien."
...
translate spanish cyril_dragon_epilogue_a34d63fb:
    ...
    c "¿A dónde va? ¡El reino está {b}por ese otro lado{/b}! Nos alejamos de donde debe gobernar. ¡Debemos volver!"
...
translate spanish cyril_dragon_epilogue_8b5f128a:
    ...
    p shout "¿Por qué gobernar un reino cuando puedo gobernar todo el cielo? Nunca he visto qué hay más allá de los Siete Reinos."

# game/cyril_ending.rpy:88
translate spanish cyril_dragon_epilogue_bb4cf534:

    # c "Well I- I hadn’t quite thought of it like that."
    c "Bueno... Nunca lo había pensado así."
...
translate spanish cyril_dragon_epilogue_29168cc0:
    ...
    c "¿Pero quién va a gobernar su reino, Su Alteza? ¡No puede marcharse así como así!"

# game/cyril_ending.rpy:94
translate spanish cyril_dragon_epilogue_5faa3da8:

    # c "There are responsibilities to be had..."
    c "Usted debe tomar ciertas responsabilidades..."
...
translate spanish cyril_dragon_epilogue_5c1588ff:
    ...
    p shocked "Ah, no me importa.
 Mientras no sea Magnolia... Sin embargo, no creo que se atreva a volver tras haberla chamuscado así."
...
translate spanish cyril_dragon_epilogue_e781e6c0:
    ...
    p smile "De hecho, ¿por qué no toma usted el trono? Manténgalo caliente por mí, por si cambio de opinión. Le {b}conozco{/b} y sé que no me traicionaría."
...
translate spanish cyril_dragon_epilogue_4f57f7b1:
    ...
    c "¿Yo? ¿Tomar el...? Ah, no, no. Yo solo soy un humilde mago. Quizás..."
...
translate spanish cyril_dragon_epilogue_68d1dfdb:
    ...
    c "Pero, ¿usted a dónde iría? ¿Y cuándo volvería?"
...
translate spanish cyril_dragon_epilogue_bec0de4c:
    ...
    p laugh "¡Volaré a donde quiera! ¡Veré todo lo que existe! ¡Y volveré cuando me plazca! Soy una dragona, Cyril, ¡una DRAGONA!"

# game/cyril_ending.rpy:100
translate spanish cyril_dragon_epilogue_d39b7feb:

    # c "But I- but… {size=-1}I’d miss you.{/size}"
    c "Pe... pero... {size=-1}La voy a echar de menos.{/size}"
...
translate spanish cyril_dragon_epilogue_6888eb41:
    ...
    p friendly "Vamos, no esté tan hecho polvo. Cuando vuelva, le contaré todas mis aventuras y podrá escribir un libro sobre mí."
...
translate spanish cyril_dragon_epilogue_ce8fbf2a:
    ...
    c "Bueno, sí, imagino que podré escribir un libro. Cuando vuelva, quién sabe cuando será eso."
...
translate spanish cyril_dragon_epilogue_72a00f10:
    ...
    p smile "¡Hasta la vista, Cyril! Debería agradecerle por el pequeño papel que ha tenido en hacer crecer mi poder más de lo que jamás habría soñado..."
...
translate spanish cyril_dragon_epilogue_49cf536c:
    ...
    c "Aprecio su oferta para gobernar el reino, pero..."
...
translate spanish cyril_dragon_epilogue_3009eaef:
    ...
    "Estaba a punto de despegar cuando su transformación me llamó la atención."
...
translate spanish cyril_dragon_epilogue_2d5863d4:
    ...
    "Con un destello, un dragón azul y aparentemente nervioso apareció de donde se encontraba Cyril."
...
translate spanish cyril_dragon_epilogue_640299c9:
    ...
    p shout "...¿Podría haber hecho eso en cualquier momento? ¿Por qué no se transformó en un dragón desde el primer momento?"
...
translate spanish cyril_dragon_epilogue_dba085c5:
    ...
    c "Nunca... ¡Nunca pensé que usted {b}querría{/b} ser un dragón!"
...
translate spanish cyril_dragon_epilogue_4407d71b:
    ...
    p laugh "¿Quién {b}querría{/b} convertirse en un dragón? ¿No es precioso, Cyril?"
...
translate spanish cyril_insane_epilogue_6b03e4a6:
    ...
    c "Por supuesto, soy totalmente consciente de que está completamente muerto y solo le estoy imaginando."
...
translate spanish cyril_insane_epilogue_59428d85:
    ...
    c "Pero me gustaría que conociera a mi propia reina imaginaria."
...
translate spanish cyril_insane_epilogue_4ae8018f:
    ...
    c "La salvé y después la ayudé a convertirse en Reina. Aunque me temo que tampoco era de verdad."
...
translate spanish cyril_insane_epilogue_904ffaa3:
    ...
    c "De todas formas, ella es mi amada, aunque soñara con ella estando solo... en ese castillo... con los dragones."
...
translate spanish cyril_insane_epilogue_bef0ef0e:
    ...
    c "Usted me mandó a allí, ¿se acuerda? Aunque no le culpo por mi {i}estado{/i}."
...
translate spanish cyril_insane_epilogue_78058ea3:
    ...
    c "Me pregunto qué sería de aquellos dragones, pero eso lo dejaremos para otro día."
...
translate spanish cyril_insane_epilogue_d8a8d10a:
    ...
    p tsk "¿Está hablando solo otra vez?"
...
translate spanish cyril_insane_epilogue_89a0f697:
    ...
    "Claro que era poderoso con ese cetro pero, desde entonces, el mago parece convencido de que nada era real."
...
translate spanish cyril_insane_epilogue_90a9558e:
    ...
    "No importaba cuántas amenazas de daño hubiera, que no había cambiado nada."
...
translate spanish cyril_insane_epilogue_3b732194:
    ...
    "Quizás debería mandarlo a que se lo coman los dragones y acabar con todo esto."
...
translate spanish cyril_insane_epilogue_50674f56:
    ...
    "Al menos tenía el cetro para mí sola y un mago loco que cumplía mis órdenes."
...
translate spanish cyril_insane_epilogue_f1380504:
    ...
    c "Ah, milady. Su Majestad. Le presento a mi antiguo maestro de magia, Dyconis."
...
translate spanish cyril_insane_epilogue_1bd19b18:
    ...
    p smile "Ya veo por qué Dyconis le mantuvo encerrado."
...
translate spanish cyril_insane_epilogue_bbc6a548:
    ...
    "Supongo que yo tengo parte de culpa, así que debería ser algo comprensiva."
...
translate spanish cyril_insane_epilogue_99703166:
    ...
    p tsk "He acabado con usted, mago. Será reincorporado al Castillo del Destierro."
...
translate spanish cyril_insane_epilogue_11ec6d11:
    ...
    p angry "Por favor, desaparezca de mi vista inmediatamente."
