...
translate spanish day1_37617f9b:
    ...
    p angry "Qué despertar más horrible, todavía no soy Reina."

# game/day1.rpy:5
translate spanish day1_4d1d485f:

    # p "But that's why I came here; to remedy that."
    p "Pero para eso he venido hasta aquí, para remediarlo."
...
translate spanish day1_2e98d094:
    ...
    p "Se supone que los dragones son poderosos y yo necesito más poder. Tengo que hablar con ellos sin que ese mago se entrometa. Quizás puedan darme más información."

# game/day1.rpy:8
translate spanish day1_c63f6f55:

    # n "Ssssomething tasssty comes!"
    n "¡Viene algo sssabrossso!"

# game/day1.rpy:9
translate spanish day1_386fcdb6:

    # p neutral "Ahem. Dragons? I wish to speak with you!"
    p neutral "Ejem. ¿Dragones? ¡Me gustaría hablar con ustedes!"

# game/day1.rpy:14
translate spanish day1_52d43e02:

    # b "Princess [p_name]. To what do we owe this great honor?"
    b "Princesa [p_name]. ¿A qué se debe este gran honor?"

# game/day1.rpy:16
translate spanish day1_53b32555:

    # n "Yesss, it's a pleasure..."
    n "Sssí, esss un placer..."
...
translate spanish day1_d8547e69:
    ...
    p shout "Seguro. Bueno, estoy buscando vasallos reales que me ayuden a destronar a mi malvada hermana. ¿Aceptáis mi oferta?"

# game/day1.rpy:19
translate spanish day1_53cb9ced:

    # n "Vasssssals? We are no sssuch thing."
    n "¿Vasssallos? No somosss vasssallos."

# game/day1.rpy:21
translate spanish day1_cb3c7d46:

    # b "Princess, our powers are extremely limited whilst we are held captive here."
    b "Princesa, nuestros poderes son muy limitados debido a nuestro estado de cautividad."
...
translate spanish day1_3bb52cb6:
    ...
    p neutral "Pensé que solo tendrían que besar a un humano y el hechizo se rompería."

# game/day1.rpy:24
translate spanish day1_adcbee8f:

    # n "If that were the casssse, I'd have kissssed you firssst and asked questionssss later."
    n "Si essse fuera el cassso, primero la habría besssado y luego habría preguntado."
...
translate spanish day1_e8818f8a:
    ...
    b "Sí, no es tan fácil como parece. Mire, Merlonious solo liberará a un dragón si prueba que ha encontrado \"el amor\" y que está reformado."

# game/day1.rpy:27
translate spanish day1_297eac73:

    # p surprised "Couldn't we overpower him? He doesn't seem that formidable..."
    p surprised "¿No podemos con él? No parece que sea un gran mago..."
...
translate spanish day1_537c5e3b:
    ...
    b "Tiene grandes poderes y los nuestros están ocultos por la maldición. Entonces, a no ser que sea una hechicera..."
...
translate spanish day1_5296f02c:
    ...
    p neutral "No lo soy. Pero me interesan los utensilios con poderes mágicos y la alquimia. ¿Los conoce?"
...
translate spanish library1_d5e305a9:
    ...
    "Soltó el libro como si fuera una patata caliente."
...
translate spanish library1_2a4b6460:
    ...
    p friendly "Deje que lo coja yo."
...
translate spanish library1_ff89e198:
    ...
    p laugh "No sé, pero creo que con {i}15 Cuentos Eróticos de Crepúsculo{/i} podría arrojar algún hechizo bastante curioso."
...
translate spanish library1_0deddba4:
    ...
    c "Por casualidad, ¿no habrá estado hablando con {i}él{/i}? ¿Esto es parte de la broma?"

# game/day1.rpy:76
translate spanish library1_dd9fa2cb:

    # p angry "Of course it is. This life is all one big joke at your expense, Moronious."
    p angry "Claro que lo es. Esta vida es una gran broma a su costa, Memonious."
...
translate spanish library1_c1ba9e19:
    ...
    p smile "Bueno, he venido a buscar algo, pero si está ocupado leyendo libros eróticos, le dejaré tranquilo."

# game/day1.rpy:81
translate spanish library1_32d5baf3:

    # c "I'm not busy- not at all!"
    c "No estoy ocupado, ¡para nada!"
...
translate spanish library1_2169be01:
    ...
    p smile "Bien. Búsqueme un libro que trate sobre utensilios poderosos en este lugar."

# game/day1.rpy:92
translate spanish library1_6493d748:

    # c "In this vicinity? Whyever would you-"
    c "¿En este lugar? ¿Por qué querría...?"

# game/day1.rpy:93
translate spanish library1_fb5e65a6:

    # p tsk "You're starting to irritate me."
    p tsk "Está empezando a molestarme."
...
translate spanish library1_efe53a8c:
    ...
    p neutral "Dando por hecho lo pobres que son sus materiales de investigación en este castillo, supongo que con esto bastará."
...
translate spanish library1_e8005e9d:
    ...
    "¿Una espada para podar setos? Inútil. ¿Poción para el sueño? Posiblemente útil, pero no es lo que estoy buscando. ¿Elixir de juventud? Ya soy joven y bonita, no lo necesito."

# game/day1.rpy:119
translate spanish library1_32039e84:

    # "This one is quite curious. This part here."
    "Esto parece curioso. Esta parte de aquí."

# game/day1.rpy:121
translate spanish library1_6f8ec670:

    # book "{size=50}The Scepter of Lavendorm{/size}"
    book "{size=50}El Cetro de Lavendorm{/size}"
...
translate spanish library1_f1a398bc:
    ...
    book "Desaparecido durante siglos, se cree que este poderoso utensilio se encuentra en [castle_name].\n"
...
translate spanish library1_c2182aba:
    ...
    book "Se dice que tiene el poder para romper hechizos, mientras que algunos escépticos piensan que se usaba como símbolo de autoridad por las familias reales y, quizás, como protección frente al asesinato.\n"
...
translate spanish library1_5b33bff1:
    ...
    book "Según textos antiguos, tiene esmeraldas incrustadas y emana un aura mágica."
...
translate spanish sharebalrung_345650f6:
    ...
    p angry "Volveré a las mazmorras. Este castillo es demasiado grande para las pocas personas que viven aquí."
...
translate spanish sharebalrung_a44aa0c5:
    ...
    p "Sí, he encontrado algo que quizás pueda ayudarme. ¿Qué sabe del Cetro de Lavendorm?"
...
translate spanish balrung_scepter_0704b2fa:
    ...
    b "Nadie ha podido encontrarlo. Se cree perdido y, dado que sus poderes se desconocen, nadie se ha molestado en buscarlo."

# game/day1.rpy:154
translate spanish balrung_scepter_281554e8:

    # p "Yes, the book said as much. Where is it?"
    p "Sí, lo he leído en el libro. ¿Dónde está?"

# game/day1.rpy:156
translate spanish balrung_scepter_7a927d92:

    # b "Perhaps that's why she chose this place..."
    b "Puede que ella eligiera este lugar por eso..."
...
translate spanish balrung_scepter_1e6d2f8a:
    ...
    b "No importa. Creo que sigue aquí. He sentido un poder latente en las paredes de este castillo, pero imaginé que sería la maldición."
...
translate spanish balrung_scepter_d68439e1:
    ...
    p "Interesante... ¿Podría precisar el lugar exacto donde ese sentimiento se hace más fuerte?"
...
translate spanish sharecyril_6154ce8a:
    ...
    p tsk "Ya soy consciente de que usted es un manipulador mágico. No vuelva a aparecer así de nuevo."

# game/day1.rpy:179
translate spanish sharecyril_83423023:

    # c "Oh, I'm sorry. I overheard that you were looking for me, and I just wanted to help-"
    c "Ah, lo siento. Me pareció escuchar que me llamaba, solo pretendía ayudarla..."
...
translate spanish sharecyril_a235670d:
    ...
    c "Bueno, no sé si varios cientos..."
...
translate spanish sharecyril_3b728114:
    ...
    c "{b}Puede{/b} que dijera que había una magia poderosa pero incontrolable que no debía buscar."
...
translate spanish sharecyril_c235cbd4:
    ...
    c "Pero me temo que solo bromeaba conmigo. Aunque no era una persona a la que le gustara mucho bromear."

# game/day1.rpy:198
translate spanish sharecyril_13029ad4:

    # p shout "So did he say {i}where{/i} not to go looking for it?"
    p shout "¿Le dijo {i}dónde{/i} no debía ir a buscarla?"
...
translate spanish sharecyril_797a7c39:
    ...
    c "No específicamente, pero dijo que estaba custodiada con una magia especial en algún lugar entre estas paredes."

# game/day1.rpy:201
translate spanish sharecyril_0c0a1e57:

    # p angry "And you didn't think to mention this earlier?"
    p angry "¿Y no se le ha ocurrido mencionarlo antes?"
...
translate spanish sharecyril_10eac071:
    ...
    c "Pensé que estaba interesada en los dragones, no en utensilios antiguos de los que todo el mundo se había olvidado."

# game/day1.rpy:204
translate spanish sharecyril_5698b76e:

    # p angry "My {i}interest{/i} is in whatever will get me on that throne the quickest!"
    p angry "¡Yo me {i}intereso{/i} por lo que me acerque con mayor rapidez al trono!"

# game/day1.rpy:205
translate spanish sharecyril_db90f9e6:

    # p angry "Don't you ever forget that."
    p angry "Que no se le olvide."
...
translate spanish explore1_982cf033:
    ...
    p tsk "Y si encuentro algo que pueda usar a mi favor, no habré malgastado este día de forma patética."
...
translate spanish explore1_3857a2ef:
    ...
    p angry "Pero le conviene saber que yo no soy una de esas damas, porque soy la única oportunidad que tiene para poder salir de aquí."

# game/day1.rpy:267
translate spanish explore1_4bd89464:

    # n "You need to get your facts sssstraight nexxxt time."
    n "La próxima vez, debería dejarlo claro desssde el principio."
...
translate spanish explore1_d01a566c:
    ...
    p shout "Tengo mi... ¡Niir! ¿A dónde ha ido, dragón sigiloso?"

# game/day1.rpy:272
translate spanish explore1_4df55790:

    # p angry "Oh, well. I didn't want you around anyway, you ridiculous reptile!"
    p angry "Ya, bueno. ¡Tampoco quería verle, reptil ridículo!"
...
translate spanish explore1_e045cbb2:
    ...
    p tsk "¡Este castillo tiene escalones infinitos!"
...
translate spanish explore1_b6f2029d:
    ...
    "Tras largas horas buscando, nada. Salvo por las deliciosas manzanas secas que encontré en las cocinas. ¿Y esta cuerda...? Supuse que no fue una total pérdida de tiempo."
