...
translate spanish day3_1d75469a:
    ...
    k_write "Ojalá no te hubieras marchado tan rápido. Sabes que no me creo los chismorreos de los cortesanos."
...
translate spanish day3_944e2b9b:
    ...
    k_write "Tú y tu hermana nunca os habéis llevado bien, eso es cierto, pero no me puedo creer que tú..."
...
translate spanish day3_414300a1:
    ...
    k_write "Bueno, tu destierro durará hasta que estés preparada para apoyar a tu hermana. Tómate todo el tiempo que necesites pero, por favor, vuelve con nosotros. "

# game/day3.rpy:14
translate spanish day3_d5df3195:

    # k_write "Magnolia's coronation won't be the same without you."
    k_write "La coronación de Magnolia no será lo mismo sin ti."
...
translate spanish day3_ba500241:
    ...
    "Hay algo en la otra cara, corazones por todos lados."
...
translate spanish day3_ff735cb4:
    ...
    m_write "El castillo está tan solitario, me mata estar tan lejos de ti."
...
translate spanish day3_ec42e8e6:
    ...
    m_write "Aunque no puedas ser Reina, estoy segura de que habrá muchas cosas importantes con las que podrás ayudarme."

# game/day3.rpy:23
translate spanish day3_931af3b2:

    # m_write "We need you here; please come back! I promise not to be too mad."
    m_write "¡Te necesitamos aquí, por favor, vuelve! Te prometo que no me enfadaré."
...
translate spanish day3_0e8cad4b:
    ...
    nvl clear
    p angry "Magnolia... ¡Qué retorcida! Aunque aparentemente quiera que vuelva, está claro que sabe que yo le envenené el té."
...
translate spanish day3_5d6f5729:
    ...
    p shout "¡Mira cómo intenta ponerme en mi lugar! \"Cosas importantes con las que podrás ayudarme\", ridículo. Sé que tiene a Padre totalmente engañado."
...
translate spanish day3_a541d4b5:
    ...
    p tsk "Pues si piensa que voy a volver para \"ayudar\" con \"cosas importantes\" como planificar bailes o dedicarme a la jardinería, está delirando."
...
translate spanish day3_937caed2:
    ...
    p_write "Me encantó recibir su carta y ver que no me ha olvidado del todo, [p_name], su otra hija, la que debería haber elegido como Reina."
...
translate spanish day3_97c99b8a:
    ...
    p_write "Me temo que lo único que podría hacerme volver sería mi nombramiento como su sucesora. No tendré la conciencia tranquila si apoyo {s}a esa zorra malvada{/s}..."
...
translate spanish day3_88559b1c:
    ...
    nvl clear
    "No, eso es demasiado obvio.  Tengo que ser más sutil."
...
translate spanish day3_82dabf03:
    ...
    p_write "No tendré la conciencia tranquila si apoyo a alguien que no le desea lo mejor a nuestro reino y que además es una inepta, ¡sin mencionar que es fea, mala, retorcida y cruel!"
...
translate spanish day3_4b0abe95:
    ...
    p_write "Espero que al menos pueda entender a su pobre, calumniada, incomprendida, leal, competente y majestuosa hija."

# game/day3.rpy:44
translate spanish day3_29677e99:

    # p_write "Love and kisses,"
    p_write "Besos y abrazos,"
...
translate spanish day3_433d16fa:
    ...
    p_write "No puedo permitir que esta incompetente, conspiradora y gran negligente gobierne el antiguo y augusto reino de [k_name]."

# game/day3.rpy:53
translate spanish day3_5867b0ad:

    # p_write "To grant the throne to Magnolia would destroy our kingdom's power and glory!"
    p_write "¡Poner a Magnolia en el trono destruirá el poder y la gloria de nuestro reino!"
...
translate spanish day3_3b6960b8:
    ...
    p_write "Mientras usted, Padre, no es capaz de ver su traición y deslealtad, yo sí que puedo, y por eso no puedo quedarme quieta y no hacer nada."
...
translate spanish day3_f98dd1e1:
    ...
    nvl clear
    p_write "Padre, si es usted inteligente y se preocupa por el bienestar de nuestro reino a largo plazo, no permitirá que tenga lugar la coronación de Magnolia y me cederá a mí el poder."
...
translate spanish day3_8154014d:
    ...
    p_write "Si no es así, haré lo que sea necesario para llegar al trono, ¡por el bien del reino!"
...
translate spanish day3_de4dbf52:
    ...
    p "Padre sabe que no podré volver nunca mientras planee coronar a mi hermana Magnolia como Reina."
...
translate spanish day3_6048f72f:
    ...
    p shout "Necesito algo poderoso. Algo que esclarezca que yo debo ser la verdadera Reina. Si no tiene algo así, entonces lárguese."

# game/day3.rpy:81
translate spanish day3_acf7e1f6:

    # n "More powerful than a dragon? My aren’t you ambitioussss?"
    n "¿Másss poderossso que un dragón? ¿No es lo que desssea?"

# game/day3.rpy:82
translate spanish day3_ec07d058:

    # p "It doesn’t take much to be more powerful than you right now."
    p "No me parece muy complicado encontrar algo más poderoso que usted."
...
translate spanish cyril3_c4ddc036:
    ...
    c "Bueno, Su Alteza. He esbozado un mapa del castillo."

# game/day3.rpy:128
translate spanish cyril3_53dde69e:

    # c "And crossed off all the little places that I know most certainly that it isn't."
    c "Y tachado los pequeños lugares en los que con seguridad no se encuentra."
...
translate spanish cyril3_c62c5dcb:
    ...
    c "Espere un momento. Recuérdeme por qué me ha engañado para que sea su sirviente."

# game/day3.rpy:131
translate spanish cyril3_a19890ca:

    # p smile "Because you have such a generous spirit."
    p smile "Porque tiene un espíritu muy generoso."
...
translate spanish cyril3_8aa2e862:
    ...
    "Supongo que mientras Memonious está trabajando en ello, será mejor que vaya buscando por mi cuenta."
...
translate spanish cyril3_6f63b77d:
    ...
    "¿Qué más podré encontrar en esta biblioteca curiosamente grande? Esta es posiblemente la única sala en el castillo que está bien cuidada."

# game/day3.rpy:145
translate spanish cyril3_366a8927:

    # "Ahhh, {i}Powerful Ingredients And Where to Find Them{/i}. Lovely."
    "Ah, {i}Ingredientes poderosos y dónde encontrarlos{/i}. Genial."

# game/day3.rpy:146
translate spanish cyril3_3c5aec45:

    # "I'll just take this back to my room where I won't be bothered."
    "Me lo llevaré a mi habitación donde no me moleste nadie."

# game/day3.rpy:149
translate spanish cyril3_9c73c592:

    # p angry "Ugh, this place smells like moss. Like stinking, rotting-"
    p angry "Aj, este lugar huele a musgo. Como apestoso y podrido..."
...
translate spanish cyril3_aa7ca88b:
    ...
    "¿Cuánto tiempo lleva en mi habitación? Y... "

# game/day3.rpy:152
translate spanish cyril3_8c946b3b:

    # extend "Is that my letter?!"
    extend "¿Es esa mi carta?"
...
translate spanish cyril3_1affc32c:
    ...
    c "Ah, vale. Me dijo que viniera porque quería verme, ¿no? Así que pensé en pasar por aquí y, vaya, ponernos al día."

# game/day3.rpy:167
translate spanish cyril3_2db29c50:

    # c "That is the terminology is it not? I haven't used it for quite some time."
    c "Esa es la terminología, ¿no es así? No la he usado en mucho tiempo."
...
translate spanish cyril3_497edcc4:
    ...
    p "Le dije que viniera a buscarme si tenía más información. ¿Tiene más información?"

# game/day3.rpy:170
translate spanish cyril3_cc350c5f:

    # c "Well ah, more to say, I have. But not more information, no."
    c "Bueno, eh, sí, algo más que decir tengo. Pero más información no."

# game/day3.rpy:171
translate spanish cyril3_efae52ba:

    # p angry "So you decided to sneak in and read my letter?"
    p angry "Así que, ¿su intención era entrar a hurtadillas y leer mi carta?"

# game/day3.rpy:172
translate spanish cyril3_30737bd7:

    # c "No! But if I may say so, you should not miss your sister's coronation."
    c "¡No! Pero si me permite que le diga, no debería perderse la coronación de su hermana."
...
translate spanish cyril3_8c50ea71:
    ...
    p friendly "¿Puede que esté lo suficientemente deprimido como para, no sé, {i}liberar a los dragones{/i}?"

# game/day3.rpy:190
translate spanish cyril3_49b99903:

    # c "Oh no. I'm not quite miserable enough for that."
    c "No, no estoy tan deprimido como para hacer eso."
...
translate spanish cyril3_1bb0bf04:
    ...
    c "La gente ni siquiera se acordaba de mi nombre e incluso mi propia madre me dijo que dejara de quejarme sobre lo que pensara la gente."

# game/day3.rpy:196
translate spanish cyril3_0ac93f2b:

    # c "Even though it was in private, and I can do what I like with my private time and..."
    c "Aunque fuera en privado, y dando por hecho que puedo hacer lo que quiera en mi tiempo privado y..."

# game/day3.rpy:197
translate spanish cyril3_1cc8df48:

    # p shocked "I've heard enough."
    p shocked "Ya he oído suficiente."
...
translate spanish cyril3_40b57951:
    ...
    p "Sí, es lamentable. Quiero decir, ¿se imagina cómo es crecer en el castillo real?"
...
translate spanish cyril3_c2b6abc3:
    ...
    p angry "Todo el mundo se arrodilla y se porta bien con una misma solo... ¡porque sí!"

# game/day3.rpy:202
translate spanish cyril3_1f1b8f3c:

    # c "Ah, yes. That does-that does sound horrible."
    c "Ah, vale. Eso... eso suena muy mal."
...
translate spanish cyril3_8e3ff355:
    ...
    c "Pero ahora está aquí, y yo estaré encantado de hacer lo que sea por complacerla, Su Alteza."

# game/day3.rpy:209
translate spanish cyril3_988b8e42:

    # p "I will take you up on that."
    p "Le tomaré la palabra."
...
translate spanish cyril3_9344e267:
    ...
    "Quizás si me tumbo y cierro los ojos se vaya."

# game/day3.rpy:232
translate spanish cyril3_7c25810c:

    # c "I do think however that it is in your best interests-"
    c "Sin embargo, creo que lo hacen por su bien..."
...
translate spanish balrung3_8fa02ee5:
    ...
    b "Princesa. Es un placer volver a verla. Pero claro, no ha venido hasta aquí para hablar conmigo. ¿Está buscando a Niir?"

# game/day3.rpy:253
translate spanish balrung3_8ed3a0ba:

    # p friendly "No, I wanted to talk to you."
    p friendly "No, quería hablar con usted."
...
translate spanish balrung3_bcc72d4c:
    ...
    b "¿En serio? Imagino que está buscando a idiota incrédulo al que pueda engañar para usar sus poderes en su beneficio, ¿no es así? Un esclavo, un lacayo, un esbirro."

# game/day3.rpy:256
translate spanish balrung3_6dfe674f:

    # p smile "No, no of course not!"
    p smile "¡No, claro que no!"
...
translate spanish balrung3_1926daee:
    ...
    b "A veces leo en la biblioteca, aunque los libros humanos son sensibleros y predecibles."

# game/day3.rpy:288
translate spanish balrung3_cb4a0b24:

    # p "Are there dragon books?"
    p "¿Hay libros para dragones?"
...
translate spanish balrung3_340ece54:
    ...
    b "La mayoría de los dragones no pierden el tiempo en leer, así que me temo que no hay muchos. Pero existen algunos libros que son obras maestras."
...
translate spanish balrung3_57bef912:
    ...
    b "Los dragones no hacemos las cosas a medias. Solo tengo uno por aquí, es poesía."

# game/day3.rpy:293
translate spanish balrung3_8ee23820:

    # p surprised "Dragon poetry? What is it like?"
    p surprised "¿Poesía de dragones? ¿Cómo es?"
...
translate spanish balrung3_b0076b79:
    ...
    b "No es tan buena cuando se traduce, pero aquí hay una que me gusta. ¿Le gustaría leerla?"
...
translate spanish balrung3_4888af71:
    ...
    book "Siempre encontrar reales sueños,"
...
translate spanish balrung3_0744d9a9:
    ...
    p "Palabras, palabras y más palabras. Aburridas e inútiles."
...
translate spanish balrung3_ec3381ce:
    ...
    b "Yo no subestimaría el poder de las palabras. A veces, diez palabras pueden conseguir lo que no pueden conseguir diez ejércitos."

# game/day3.rpy:328
translate spanish balrung3_3d3f92e8:

    # p "I'd prefer the armies."
    p "Yo prefiero los ejércitos."

# game/day3.rpy:330
translate spanish balrung3_bc1bfd68:

    # b "For your purposes, perhaps armies would work better."
    b "Para conseguir su objetivo, quizás los ejércitos sean lo mejor."

# game/day3.rpy:333
translate spanish balrung3_09f0a7e8:

    # p "I like the part about vanquishing. Why do you like it?"
    p "Me gusta la parte de invadir. ¿Por qué le gusta?"
...
translate spanish balrung3_a98663c4:
    ...
    b "Habla sobre las libertades que para mí ya no existen. Sobre una vida del pasado que me parece muy lejana. Sobre las posibilidades del futuro."

# game/day3.rpy:336
translate spanish balrung3_fe360ff6:

    # p shocked "Is this really poetry? I see no rhymes, no pattern of syllables."
    p shocked "¿Eso es poesía de verdad? No hay rimas ni patrones en cuanto a las sílabas."

# game/day3.rpy:338
translate spanish balrung3_09f1eea5:

    # b "This is an example of the 7-chain form. There are seven lines in the poem."
    b "Es un ejemplo de la forma de las 7 cadenas. Hay siete líneas en el poema."
...
translate spanish balrung3_79dfa180:
    ...
    b "La primera es una sola palabra que presenta el tema del poema. Las cinco siguientes la desarrollan y la ultima muestra el tema del poema de forma distinta."
...
translate spanish balrung3_aee1b2df:
    ...
    b "Y el sonido final de cada palabra tiene que ser el mismo que la palabra siguiente."
...
translate spanish balrung3_9301e409:
    ...
    b "Es más sencillo en nuestro idioma por la simplicidad de la conjugación de los verbos y la gran variedad... Perdonadme, Princesa. Parece que le estoy aburriendo."

# game/day3.rpy:344
translate spanish balrung3_db20319f:

    # p shocked "Yes, you are. Goodbye."
    p shocked "Sí, me está aburriendo. Adiós."

# game/day3.rpy:346
translate spanish balrung3_f7a0a81a:

    # b "Another time, perhaps."
    b "Quizás en otro momento."

# game/day3.rpy:353
translate spanish niir3_cf0d6cc5:

    # n "Follow me and I’ll sssshow you ssssomething."
    n "Sssígame y le enssseñaré algo."

# game/day3.rpy:354
translate spanish niir3_939cab7d:

    # p neutral "Very well. Lead on, Niir."
    p neutral "De acuerdo. Usted primero, Niir."
...
translate spanish niir3_82d45aea:
    ...
    n "¿Por qué ssse preocupa tanto por el reino? ¿Qué ha hecho el reino por usssted?"

# game/day3.rpy:363
translate spanish niir3_cfc5c629:

    # p "Nothing, yet. That’s why I need to be Queen."
    p "Todavía nada. Por eso necesito ser Reina."

# game/day3.rpy:364
translate spanish niir3_920dcefd:

    # p shocked "Surely you can understand wanting greater power and recognition?"
    p shocked "Entonces puede entender por qué quiero más poder y reconocimiento."
...
translate spanish niir3_47854c26:
    ...
    n "Hay otrasss formas de conssseguir poder. Formas más divertidasss que pertenecer a la realeza."
...
translate spanish niir3_94a3418a:
    ...
    p surprised "¡Me recuerda a mi padre! Aunque no me suele recordar a él. A él no le importa cómo me vista, qué haga o lo que quiero."
...
translate spanish niir3_2cd8f4e1:
    ...
    n "Parece dolorossso, princesssa. Me da igual.
 Pero me gussstaría saber cuálesss son susss planesss porque parece que no tiene ninguno."

# game/day3.rpy:384
translate spanish niir3_9ea20867:

    # n "Watching you fail could be entertaining."
    n "Ver cómo fracassssa podría ser entretenido."

# game/day3.rpy:385
translate spanish niir3_b628dd60:

    # p tsk "Hmph. That’s no way to talk to your future Queen."
    p tsk "Bueno. No debería hablarle así a su futura Reina."

# game/day3.rpy:387
translate spanish niir3_4739ba94:

    # n "My queen? Ha ha ha ha. I am a dragon. I have no queen."
    n "¿Mi Reina? Ja, ja, ja, ja. Sssoy un dragón. Yo no tengo reina."
...
translate spanish niir3_01961621:
    ...
    p laugh "{b}Memonious{/b} también podría ser su reina, que controla a dónde puede ir y le mantiene en forma humana. Yo no sería tan cruel con usted."
...
translate spanish niir3_3770d8db:
    ...
    n "Pero usssted es ligeramente más favorecedora. Solo ligeramente."
...
translate spanish niir3_57f38182:
    ...
    p friendly "Bueno, sí, es un deber real ser favorecedora... Aunque mi presencia se mejoraría si dispusiera de todo mi vestuario real. ¿Hemos llegado ya?"

# game/day3.rpy:399
translate spanish niir3_ed8f5dac:

    # n "Ssssoon. Hmmm. Where is this royal wardrobe of yoursss?"
    n "Llegaremosss. Mmmm. ¿Dónde ssse encuentra essse vessstuario real?"
...
translate spanish niir3_8999b9ec:
    ...
    p tsk "¡Por supuesto que voy a volver! Pero cuando vuelva, tendré tanto poder y grandiosidad que no les quedará otra que aceptarme como su Reina. "
...
translate spanish niir3_33359973:
    ...
    p angry "Pensé que encontraría algo que me ayudara por aquí, pero parece que solo hay habitaciones llenas de polvo y dragones viejos."
...
translate spanish niir3_47c16083:
    ...
    n "Marcharssse no sssiempre esss una opción. Por lo menosss no para los dragonesss. Puede que intente retenerla aquí."
...
translate spanish niir3_6fad8bd2:
    ...
    p "Bueno. Entonces su misión debe incluir renovar el castillo, renovar el vestuario, hacerme Reina y ser un poco..., menos pesado."
...
translate spanish niir3_d55fad5f:
    ...
    n "Parece que hará falta menos persssuasssión de la que me pensssaba."
...
translate spanish niir3_ecffd04f:
    ...
    p angry "No me ha persuadido de nada, todavía. Enséñeme de lo que es capaz y entonces decidiré."
...
translate spanish niir3_a268cbc0:
    ...
    n "Haré que todo sssea másss entretenido. Creo que he exprimido demasssiado a Balrung."

# game/day3.rpy:421
translate spanish niir3_7812a96c:

    # n "He isss less interesssting company than he initially wassss."
    n "Sssu compañía esss menosss interesssante de lo que era antessss."

# game/day3.rpy:427
translate spanish niir3_5f787d79:

    # n "What is your cassstle like? Better than thisss?"
    n "¿Cómo esss sssu cassstillo? ¿Mejor que essste?"
...
translate spanish niir3_fdf74ac6:
    ...
    p "Por supuesto. Aunque este castillo tiene una cierta..., gravedad que no se encuentra en todos los castillos hoy en día."
...
translate spanish niir3_0a745692:
    ...
    p smile "Mi castillo era..., {b}es{/b} precioso, con vidrieras en las que se ven escenas victoriosas de mis ancestros y con todas las comodidades que merece una Reina."
...
translate spanish niir3_eb33426b:
    ...
    n "Puede que le ayude a conssseguir essse cassstillo. Pero todavía no hemosss hecho un trato. ¿Qué haremosss con sssu padre sssi le ayudo a conssseguirlo?"

# game/day3.rpy:432
translate spanish niir3_d28c0f19:

    # p angry "Father? Well, I...he... what do you care what I do with my father?!"
    p angry "¿Padre? Bueno, yo... Él... ¿A usted qué le importa qué hago yo con mi padre?"
...
translate spanish niir3_c1370a7b:
    ...
    n "Vaya, essso le ha dolido. Sssuele passsar cuando ssse trata de losss padres. Al menosss sssu padre no era un dragón."
...
translate spanish niir3_2ca2fba0:
    ...
    p "¿Qué hará cuando sea libre? Además de ser mi fiel esclavo, por supuesto."

# game/day3.rpy:453
translate spanish niir3_a9fd7b33:

    # n "I’ll pretend you didn’t ssssay that."
    n "Haré como que no ha dicho essso."
...
translate spanish niir3_fb8368b0:
    ...
    n "No recuerdo haber sssido libre de verdad. Hace tanto tiempo."
...
translate spanish niir3_bd568c3b:
    ...
    p smile "Seguro que se le ocurre {b}algo{/b}. Volar en un volcán, devorar un rebaño de ovejas o diezmar el castillo de un enemigo."
...
translate spanish niir3_8c9a9111:
    ...
    p smile "En realidad, no tiene que salir del castillo de forma que me sirva más adelante; solo tiene que hacer el suficientemente daño como para asustar a todo el mundo."
...
translate spanish niir3_2680f476:
    ...
    n "¿Quién {b}es{/b} usted, Princesssa? No ssse comporta como ninguna otra pricesssa que haya conocido."
...
translate spanish niir3_1d3328d8:
    ...
    n "Lasss princesssasss no me dicen que devore a una oveja o que diezme un cassstillo. Si esss essso a lo que ssse refiere. Pensssaba que sssugerir esssasss cosssasss no era algo «real»."

# game/day3.rpy:466
translate spanish niir3_4b487141:

    # n "Won’t your people be displeasssed with your hearty appetite for destruction?"
    n "¿A sssu pueblo no le molessstará su sssed de dessstrucción?"
...
translate spanish niir3_4887e44e:
    ...
    p laugh eyes closed "No ansío la destrucción, ¡sino el trono! Y si un poco de veneno no funciona, tengo que intentarlo con fuego de dragón."

# game/day3.rpy:468
translate spanish niir3_5441e386:

    # "Oops! Did I mention the poison?!"
    "¡Vaya! ¿He dicho veneno?"
...
translate spanish niir3_283cb966:
    ...
    n "¿Veneno? Lo tendré en cuenta la próxima vez que me ofrezca un bocado de cualquier cosssa."
...
translate spanish niir3_832acb60:
    ...
    p surprised "¡Quería decir centeno! ¡El centeno no hace nada! Bueno, ¿este es el lugar que quería enseñarme?"

# game/day3.rpy:473
translate spanish niir3_d11e1bee:

    # n "Not yet! We are almossst there. I just got... dissstracted."
    n "¡Todavía no! Casssi hemosss llegado. Me he... dissstraido."
...
translate spanish niir3_66a6c984:
    ...
    p shout "Espere, ¿cómo salgo de aquí? ¡Niir! ¡No puede abandonar así a su Reina!"
...
translate spanish niir3_039aaa73:
    ...
    "Bueno. Seguro que puedo volver yo sola. Con tiempo."
...
translate spanish strings:
    ...
    # day3.rpy:33
    old "Haughtily."
    new "De forma arrogante."

    # day3.rpy:33
    old "No reply. Let them wonder."
    new "No contestar. Dejarlos intrigados."
    ...
    new "Preguntarle a Memonious."

    # day3.rpy:98
    old "Go ask Balrung"
    new "Preguntarle a Balrung."
    ...
    # day3.rpy:270
    old "\"I will join you.\""
    new "\"Me uniré a usted.\""

    # day3.rpy:270
    old "\"No, I must ask Cyril about it.\""
    new "\"No, tengo que preguntarle a Cyril.\""

    # day3.rpy:270
    old "\"I will look for it myself.\""
    new "\"Lo buscaré yo misma.\""

    # day3.rpy:323
    old "\"Words, words, words. Boring!\""
    new "\"Palabras, palabras y más palabras. ¡Me aburre!\""

    # day3.rpy:323
    old "\"I like the 'vanquish' part.\""
    new "\"Me gusta la parte de invadir.\""
