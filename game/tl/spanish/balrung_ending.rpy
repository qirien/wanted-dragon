...
translate spanish balrung_epilogue_81244952:
    ...
    b "Su reino es, en efecto, hermoso, mi querida Reina."
...
translate spanish balrung_epilogue_3d979f89:
    ...
    p smile "Cierto... Es bueno saber que no lo hemos convertido en cenizas. El hecho de que el nuevo Rey pueda hacerlo en cualquier momento es una gran motivación."
...
translate spanish balrung_epilogue_b1a9fab9:
    ...
    b "Sí... Menudo espectáculo, ¿verdad?"
...
translate spanish balrung_epilogue_fae65d9e:
    ...
    b "Creo que a su hermana le encantará la Academia."
...
translate spanish balrung_epilogue_41b6293f:
    ...
    "Lo había conseguido. Finalmente, era la Reina. Hice pequeños sacrificios..."
...
translate spanish balrung_epilogue_5a4a00aa:
    ...
    "Pero Madre siempre dijo que a una Reina nunca le inquieta el pasado."
...
translate spanish balrung_epilogue_75b91a82:
    ...
    "¿Por qué preocuparme por eso cuando puedo disfrutar de lo que tengo ahora?"
...
translate spanish balrung_epilogue_57c8104e:
    ...
    p smile "Pero me gusta besar cuando estoy de humor."
...
translate spanish balrung_revenge_epilogue_1d573fee:
    ...
    p tsk "Debo ser paciente. ¡No permitiré que este pequeño contratiempo fastidie mis planes para [k_name]!"
...
translate spanish balrung_revenge_epilogue_0368402f:
    ...
    "Me senté para urdir ciertos planes. Era demasiado tarde para detener la coronación. Pero si Magnolia muriera, yo seguiría en la línea de sucesión."
...
translate spanish balrung_revenge_epilogue_8a372434:
    ...
    "Una paloma que aterrizaba en la mesa interrumpió mis planes. ¿Una carta?"
...
translate spanish balrung_revenge_epilogue_dc26fcaf:
    ...
    "¿¡Servían pasteles de canela para {b}ella{/b}!?"
...
translate spanish balrung_revenge_epilogue_417ecf46:
    ...
    m_write "He conocido al hombre más maravilloso. Es un poco mayor, pero no me importa. Escribe poemas maravillosos..."
...
translate spanish balrung_revenge_epilogue_cc9187a3:
    ...
    nvl clear
    m_write "Padre dice que será un gran paso hacia la integración de los dragones en la sociedad."
...
translate spanish balrung_revenge_epilogue_5fa3f439:
    ...
    m_write "{size=+15}Reina{/size} Magnolia."
...
translate spanish balrung_revenge_epilogue_fb9af067:
    ...
    nvl clear
    p surprised "No podía ser Balrung..."
...
translate spanish balrung_revenge_epilogue_dba5665b:
    ...
    p tsk "Tiene que ser él. ¿Cuántos viejos dragones poetas hay?"
...
translate spanish balrung_revenge_epilogue_daf37adc:
    ...
    p shout "¡Víbora viciosa! ¡Serpiente soberbia! ¡Culebra cruel! ¡Reptil ridículo! Ese, ese..."
...
translate spanish balrung_revenge_epilogue_166c9e67:
    ...
    "Y tras haber hecho tantos sacrificios..."
...
translate spanish balrung_revenge_epilogue_eb360ab1:
    ...
    p "Pero... ¡Tengo todo este castillo a mi disposición! ¡Encontraré la forma! ¡{b}Seré{/b} Reina! ¡Ya verá, Madre!"
...
translate spanish balrung_revenge_epilogue_9ea8b760:
    ...
    p "¡Esto no cambia nada! ¡Memonious y yo tenemos el cetro y juntos libraremos [k_name] de los dos déspotas ilegítimos!"
...
translate spanish balrung_ending_ccc4b7dc:
    ...
    "Ya que Memonious no podía atacarnos, alargué mi brazo para coger un trapo y me giré para mirar a Balrung. Seguía en el suelo, pero estaba respirando."

# game/balrung_ending.rpy:100
translate spanish balrung_ending_299312de:

    # "Slowly, he opened his eyes, and I helped him sit up."
    "Lentamente, abrió los ojos y le ayudé a incorporarse."
...
translate spanish balrung_ending_cbad5aed:
    ...
    p smile "Sí, debemos estar agradecidos de habernos librado de él."

# game/balrung_ending.rpy:106
translate spanish balrung_ending_19dfcf96:

    # b "I meant you."
    b "Me refería a usted."
...
translate spanish balrung_ending_c239b793:
    ...
    b "Usted me liberó, Princesa, y yo quiero ayudarla. ¿Qué mejor manera de ayudarle a mantener su reino que sirviendo a su lado?"

# game/balrung_ending.rpy:113
translate spanish balrung_ending_71819f5b:

    # "He would be useful...but could he really help me?"
    "Podía serme útil pero... ¿Cómo podría ayudarme?"
...
translate spanish balrung_ending_eb017a12:
    ...
    p tsk "Usted dice que tiene grandes poderes como dragón. El hechizo de Memonious se ha roto, ¡así que muéstremelos!"
...
translate spanish balrung_ending_2a404fe1:
    ...
    "Sacudió la cabeza y su piel reluciente se estiró, y estiró, y estiró, convirtiéndose en grandes escamas rojas."
...
translate spanish balrung_ending_a46cc2e4:
    ...
    "Unas alas emergieron de su espalda que se batieron en el aire como olas que se estrellan contra el casco de un barco."
...
translate spanish balrung_ending_81d3c409:
    ...
    "Embistió la pared de la cocina e hizo un gran agujero en ella. Me miró sarcásticamente con esos ojos de reptil que esperaban mi respuesta."
...
translate spanish balrung_ending_e85be174:
    ...
    p smile "Balrung, su paciente crueldad y sus poderes sobre el aire y el fuego me ayudarán a que pueda servirme como mi Rey. Ahora, deje que me monte en su grupa y llévenos a [k_name]."
...
translate spanish balrung_ending_a9cfaf4f:
    ...
    b "Qué excelente futuro nos espera. ¡Nadie osará desafiar nuestro reinado!"
...
translate spanish balrung_ending_18e58936:
    ...
    "Bajo una ráfaga de vientos y polvo, volamos desde las mazmorras hacia el ancho cielo crepuscular. Balrung lanzó una bola de fuego hacia su antigua prisión, solo por pura diversión."
...
translate spanish balrung_ending_a43ee389:
    ...
    "Con un dragón a mi lado, mi padre {b}tendría{/b} que hacerme Reina... Si no, me aseguraría de que no tuviera otra alternativa."
...
translate spanish balrung_ending_ec9aad6a:
    ...
    "Y Balrung serviría como valioso aliado si gobernáramos juntos."
...
translate spanish balrung_ending_f49c9249:
    ...
    p surprised "Al admirar su paciente crueldad, me doy cuenta de que no podrá ser mi Rey. Podrá ser un consejero."
...
translate spanish balrung_ending_d71a84c8:
    ...
    b "Oh, jo, jo. Le dejo ganar un par de partidas a Reinas y peones y se cree la mejor estratega."
...
translate spanish balrung_ending_ab264624:
    ...
    b "No, Princesa, no serviré para usted a no ser que sea al mismo nivel."
...
translate spanish balrung_ending_62c3065f:
    ...
    b "Una pena. Si cambia de opinión, me atreveré a devastar el reino de [k_name]. Podrá encontrarme sentado en mi trono mañana por la tarde."

# game/balrung_ending.rpy:148
translate spanish balrung_ending_7093dae5:

    # p tsk "I don't need any King telling me what to do!"
    p tsk "¡No necesito que ningún Rey me diga lo que tengo que hacer!"
...
translate spanish balrung_ending_a1b3622d:
    ...
    b "Una pena. Me ha divertido pasar tiempo con usted. Pero no creo conveniente obligarla a que cambie de opinión. De cualquier modo, ya aprendí esa lección."

# game/balrung_ending.rpy:152
translate spanish balrung_ending_4838d0aa:

    # "In a whoosh of wings, he was gone."
    "Como un silbido en el viento, se fue."

# game/balrung_ending.rpy:155
translate spanish balrung_ending_b61a8a96:

    # "Leaving several shiny red scales behind."
    "Dejó atrás varias escamas rojas."
...
translate spanish balrung_ending_24e6a9d8:
    ...
    p laugh eyes closed "¡Con esas escamas podía hacer tantas pociones de persuasión como quisiera! ¡Me coronaré Reina yo misma! ¡Mua, ja, ja, ja!"
...
translate spanish balrung_ending_aac45828:
    ...
    c "... ¡Princesa! ¡Lo encontré! ¡El Cetro! ¡Ha estado bajo la cama de Balrung todo este tiempo!"
...
translate spanish balrung_ending_9618d11d:
    ...
    p laugh "Mua, ja, ja... ¿Se olvidó del Cetro de Lavendorm? ¡Menudo idiota! ¡Memonious!"
...
translate spanish balrung_ending_b7f59aea:
    ...
    p smile "¿Atacamos al malvado dragón?"
...
translate spanish imprisoned_epilogue_de2b2d90:
    ...
    c "Le he traído el desayuno, su Alteza."
...
translate spanish imprisoned_epilogue_cd70d8be:
    ...
    "Tiré el cuenco a su ridícula cara y golpeé su patético sombrero. Niir se lo arrebató e hizo una mueca."
...
translate spanish imprisoned_epilogue_9ca9cdb3:
    ...
    n "Vaya, las cosssasss serán más interesssantesss {b}contigo{/b} rondando por aquí."
...
translate spanish imprisoned_epilogue_0ed8fec6:
    ...
    c "Eso ha sido muy impertinente. No creo que haya enmendado demasiado su comportamiento."
...
translate spanish imprisoned_epilogue_7e1da2ec:
    ...
    c "¡Su padre espera que le mantenga al corriente de todo lo que ocurra y todavía no tengo nada que contarle!"
...
translate spanish imprisoned_epilogue_091f4734:
    ...
    p shout "Mi hermana le ha obligado a hacer esto, ¿no es así? ¡¿NO ES ASÍ?! Ella cree que ha ganado, ¡pero se equivoca! ¡Finalmente escaparé y OS CASTIGARÉ A TODOS!"
...
translate spanish imprisoned_epilogue_8ead9a81:
    ...
    c "Ahora, Princesa. Puede que me haya llevado una semana, pero sabía que al final se acabaría delatando."
...
translate spanish imprisoned_epilogue_fc5081c3:
    ...
    c "Empiece a reflexionar en su comportamiento y pronto comprenderá cuál es su deber."
...
translate spanish imprisoned_epilogue_b025352d:
    ...
    c "Yo confío en que puede cambiar. Los dragones lo han hecho, ¿por qué usted no?"
...
translate spanish imprisoned_epilogue_e4849acf:
    ...
    p tsk "... Lo mataré. ¡Le cortaré los dedos de las manos y los dedos de los pies y alimentaré a sus estúpidos dragones con ellos!"
...
translate spanish imprisoned_epilogue_18f2d7f7:
    ...
    c "Lo dejaré pasar porque sé que no lo decía en serio, Princesa. Le diré a su padre que está empezando a ver cuáles son sus errores."
...
translate spanish imprisoned_epilogue_04d7c238:
    ...
    c "Le veo en la cena. Espero que entonces sea más agradable."
...
translate spanish imprisoned_epilogue_729795e4:
    ...
    "Era imposible. ¿Cómo habíamos llegado a esto? Creía que lo tenía en la palma de mi mano, pero..."
...
translate spanish imprisoned_epilogue_fc8f631e:
    ...
    "... No voy a darme por vencida. No era demasiado tarde para escapar de este infierno y volver a [k_name]."
...
translate spanish imprisoned_epilogue_ccf8b5f8:
    ...
    "Debo ser más cautelosa, urdir mejores planes, desempeñar el papel de buena princesa y, entonces, VENGARME. ¡De todos ellos!"
