...
init -1 python hide:
    ...
    config.window_title = u"Wanted: Dragon"
    ...
    style.default.font = "Quivira.ttf"
...
init -1 python hide:
    ...
    style.say_label.font="Anderson Thunderbirds Are GO!.ttf"
...
init python:
    ...
    build.executable_name = "Wanted: Dragon"
