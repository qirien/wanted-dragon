...
label joinmage:
    ...
    ## MAGE ROUTE
    label mage_time3:
    m "I know this was you Niir!"
    "{i}He he he, ha ha ha...{/i}"
    m "And you mark my words!  I will stop you, I will!"
    m "As soon as I find that proper spellbook!"
    p "Doing some reading?"
    m "Yah!"
    "He dropped the book like it was a hot potato."
    m "Princess.  Yes, well I..."
    p "Let me get that."
    ...
    m "We joke together all the time.  Ha ha ha."
    m "Hilarious."
    m "Well, anyway.  I must find my spellbook.  My real spellbook."
    m "Not.. this."
    p "I'm not sure, I think {i}15 Erotic Tales by Twilight{/i} could cast a completely different kind of spell."
    m "..."
    m "Have you been talking with {i}him{/i} perchance?  Is this all part of the joke?"
    p "Of course it is.  This life is all one big joke at your expense, Moronious."
    m "Merlonious.  Cyril Merlonious."
    p "Anyways, I came by for some advice, but if you are busy reading erotic tales, I will let you be."
    m "I'm not busy- not at all!"
    m "Please, do spend time with me.  I mean, ask away!  I will always lend an ear."
...
label mage_time4:
    m "Ah, yes.  Princess."
    m "Have you ever had one of those days?"
    p "One of... those days?"
    m "The days when nothing seems to go right."
    m "I honestly felt like everything was coming together and then-"
    m "Alekaadoo!  Everything goes topsy turvy."
    p "Is this to do with dragons stealing your spellbook again?"
    m "Oh?  You think they stole it?"
    p "Is the sky blue?"
    m "Ah.  A riddle!  I am quite fond of riddles."
    p "No, it was sarca- you know, never mind."
    m "But not on a day like today."
    m "On a day like today I would much rather hide my head in my hat."
    p "Perhaps you're feeling miserable enough to, I don't know, {i}release the dragons?{/i}"
    m "Oh no.  I'm not quite miserable enough for that."
    p "Well, what can we do to make you {i}more{/i} miserable then?"
    m "Hmmm... I guess if I am to be reminded of my childhood I will probably be more miserable."
    p "{i}Your{/i} childhood mage?  What was so wrong with {i}your{/i} childhood?"
    m "I learned all my spells quite well, but I was rather ignored for the flashier mages."
    m "People didn't really remember my name and my own mother told me to stop snivelling about being forgotten."
    m "Even though it was in private, and I can do what I like with my private time and..."
    p "I've heard enough."
    m "Y-ou have?"
    ...
    m "Ah, yes.  That does-that does sound horrible."
    ...
    m "Well, she is the elder out of you... so I'm sure it was just-"
    p "If I want your opinion I'll ask."
    m "I'm sorry you had such a dreadful time."
    m "But you are here now, and I am more than willing to do anything to appease you, your majesty."
...
label mage_time6:
    p "Merlonious!"
    m "It's actually.  Yes, Merlonious.  That is my name."
    ...
    m "Errr, yes.  I mean no.  Not entirely in person, no.  But I have watched the dragons and read some rather riveting books.  But short answer… erm, no."
