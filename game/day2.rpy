label day2:
    ...
    n smirk "You were banisshhed? Your position musst be desssperate, then."
    p "How long have you been eavesdropping?!"
    n mischief "Long enough to hear you sssnorrrring. Mossst unladylike."
    p "Moronious!"
    ...
    n neutral "If you think Cccyril is capable--"
    ...
    n frown "Disssapointing. I had ssso many plansss..."
    c hat angry "{font=fonts/ankecallig-fg.ttf}Protaegis! Protaegis Cubiculum!{/font}"
    ...
    n neutral "Like ssso many other thingsss."
    ...
    n angry "I have tesssted that ssspell before. I have no desssire to experrrience it again."
...
label dinner_party:
    ...
    b smile "You assumed she wanted be alone, with you, over a candlelit meal? That's rather presumptuous, Merlonious."
    ...
    c hat angry "{font=fonts/ankecallig-fg.ttf}Vittus Cottura{/font}!"
    ...
    n concerned "We’re waitingggg."
    c hat concerned eyes closed "Do be quiet, dragon, you are making me lose my concentration."
    c hat angry "{font=fonts/ankecallig-fg.ttf}Vittus Cottura Splendida{/font}!"
    show cyril hat concerned with magic_flash
    # TODO: magic vfx
    ...
    n sad "Ohhh, what I wouldn't give for a bit of deer, or mutton, or even ssssquirrel!"
    b neutral "Elk..."
    n neutral "Turrrkey..."
    b smirk "Bison..."
    n smile "Rrrrabbit!"
    ...
    n mischief "Desssstiny, you ssssay?"
    ...
    n determined "Dragonsss have no allegiancccce." 
    ...
    n mischief "Or we could dissscusss other forbidden topicsssss..."
    ...
    n smirk "Ssssimplistic Cccyril.  What ssshall we do with you?"
    c hat concerned "I don’t think we need to do any-"
    show niir mischief at quarterleft with quickmove
    show niir at right with quickmove
    c concerned blush "Excuse me, dragon!  Just what do you think you’re...."
    n happy "Hahahaha.  Oh, look at that.  Hissss faccce is red."
    ...
    n neutral "Thissss inssstant, you sssay?"
    show niir at center
    ...
    n mischief "How about you fetch?  Insssstead of jumping."
    c angry "Don’t you dare throw that Ni-"
    show niir neutral at quarterleft with quickmove
    ...
    menu:
        ...
        "Flirt with Niir":
            ...
            n smirk "I would like to have my handsss on your-"
            ...
            n determined "Nexxxxt time, Princessss."
            show cyril hat concerned at left with moveinleft
    ...
    n smirk "At leasssst the cccchef provided usss with entertainment."
